...
import icon from "../assets/icons8-persona-100_white.png";
...
export const Navbar: FC<props> = ({ setToken, username }: props) => {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      const data = await axios.get(
        "http://localhost:8080/visualdb-api/logout",
        {
          headers: {
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-16" src={logo} alt="Your Company" />
                    </div>
